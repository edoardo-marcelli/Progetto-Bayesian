...
set.seed(1235)
svlw<-SVLWfun(y,N=1000,m0,C0,ealpha=0.12,valpha=0.4,ebeta=1,vbeta=0.3,nu=0.11,lambda=0.1)
```

```{r echo=FALSE, fig.align='center', fig.cap="Kalman Filtered States with credible interval (in red)", fig.height=8, fig.pos='ht', fig.width=8, message=FALSE, warning=FALSE, results=F}
