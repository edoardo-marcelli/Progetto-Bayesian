...
In particular, the logic behind the expression for $\mathcal{V}_t(\varphi)$ is the same as described in section \ref{asympt_IS}. In fact, recall that the estimator with respect to the filtering distribution is a more sophisticated form of IS estimator, where the target distribution differs from the proposal one. \ 
