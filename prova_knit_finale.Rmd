...
\begin{equation*}
    \begin{split}
        \hat{\mathcal{V}}_t(\varphi)&:=\mathcal{V}_{t-1}(M_t\varphi)+Var_{\Q_{t-1}M_t}(\varphi) \text{ }\forall t\geq1, \\
