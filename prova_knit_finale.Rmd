...
```{r echo=FALSE, fig.align='center', fig.cap="Observations and filtered volatility, 3 indices", fig.height=4, fig.pos='H', fig.width=8, message=FALSE, warning=FALSE, results=F}
...
ggarrange(plotobs9,plotobs10)
ggarrange(plotobs11,plotobs12)
