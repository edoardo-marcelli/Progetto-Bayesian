...
Filtplot1<-function(dataframe,title){
  mean=sv_bpf1
  mean1=exp(mean/2)
...
Filtplot3<-function(dataframe,title){
  mean=sv_apf1
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot4<-function(dataframe,title){
  mean=sv_lw1
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot5<-function(dataframe,title){
  mean=sv_bapf1
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot6<-function(dataframe,title){
  mean=sv_sis1
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
plotobs1<-Filtplot1(dfsv1,"Bootstrap Particle Filter SP500")
plotobs2<-Filtplot2(dfsv2,"Opt Ker Guided Particle Filter SP500")
plotobs3<-Filtplot3(dfsv3,"Auxiliary Particle Filter SP500")
plotobs4<-Filtplot4(dfsv4,"Liu and West Filter SP500")
plotobs5<-Filtplot5(dfsv5,"Always Resampling SP500")
plotobs6<-Filtplot6(dfsv6,"No Resampling SP500")
...
Filtplot7<-function(dataframe,title){
  mean=sv_bpf2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot8<-function(dataframe,title){
  mean=sv_gpfopt2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot9<-function(dataframe,title){
  mean=sv_apf2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot10<-function(dataframe,title){
  mean=sv_lw2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot11<-function(dataframe,title){
  mean=sv_bapf2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot12<-function(dataframe,title){
  mean=sv_sis2
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
plotobs7<-Filtplot7(dfsv7,"Bootstrap Particle Filter STOXX50E")
plotobs8<-Filtplot8(dfsv8,"Opt Ker Guided Particle Filter STOXX50E")
plotobs9<-Filtplot9(dfsv9,"Auxiliary Particle Filter STOXX50E")
plotobs10<-Filtplot10(dfsv10,"Liu and West Filter STOXX50E")
plotobs11<-Filtplot11(dfsv11,"Always Resampling STOXX50E")
plotobs12<-Filtplot12(dfsv12,"No Resampling STOXX50E")
...
Filtplot13<-function(dataframe,title){
  mean=sv_bpf3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot14<-function(dataframe,title){
  mean=sv_gpfopt3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot15<-function(dataframe,title){
  mean=sv_apf3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot16<-function(dataframe,title){
  mean=sv_lw3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot17<-function(dataframe,title){
  mean=sv_bapf3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
Filtplot18<-function(dataframe,title){
  mean=sv_sis3
  mean1=exp(mean/2)
  dataframe<-data.frame(dataframe,mean1)
...
plotobs13<-Filtplot13(dfsv13,"Bootstrap Particle Filter DJI")
plotobs14<-Filtplot14(dfsv14,"Opt Ker Guided Particle Filter DJI")
plotobs15<-Filtplot15(dfsv15,"Auxiliary Particle Filter DJI")
plotobs16<-Filtplot16(dfsv16,"Liu and West Filter DJI")
plotobs17<-Filtplot17(dfsv17,"Always Resampling DJI")
plotobs18<-Filtplot18(dfsv18,"No Resampling DJI")
...
plotcomp1<-Filtplot1(dfsv1,"Bootstrap Particle Filter SP500")
plotcomp2<-Filtplot2(dfsv2,"Opt Ker Guided Particle Filter SP500")
plotcomp3<-Filtplot3(dfsv3,"Auxiliary Particle Filter SP500")
plotcomp5<-Filtplot5(dfsv5,"Always Resampling SP500")
plotcomp6<-Filtplot6(dfsv6,"No Resampling SP500")
...
Filtplot1<-function(dataframe,title){
  ...
  ggplot(dataframe,aes(x=timeframe))+
    geom_line(aes(y=realisedx1, col="Proxy", linetype="Proxy"))+
    geom_line(aes(y=mean1, col="Filtered Volatility", linetype="Filtered Volatility"))+
    scale_color_manual("",
...
plotproxy1<-Filtplot1(dfsv1,"Bootstrap Particle Filter SP500")
plotproxy2<-Filtplot2(dfsv2,"Opt Ker Guided Particle Filter SP500")
plotproxy3<-Filtplot3(dfsv3,"Auxiliary Particle Filter SP500")
plotproxy4<-Filtplot4(dfsv4,"Liu and West Filter SP500")
plotproxy5<-Filtplot5(dfsv5,"Always Resampling SP500")
plotproxy6<-Filtplot6(dfsv6,"No Resampling SP500")
...
Filtplot7<-function(dataframe,title){
  ...
  ggplot(dataframe,aes(x=timeframe))+
    geom_line(aes(y=realisedx2, col="Proxy", linetype="Proxy"))+
    geom_line(aes(y=mean1, col="Filtered Volatility", linetype="Filtered Volatility"))+
    scale_color_manual("",
                       values=c("Proxy" = "black",
                                "Filtered Volatility"= "red"))+
...
plotproxy7<-Filtplot7(dfsv7,"Bootstrap Particle Filter STOXX")
plotproxy8<-Filtplot8(dfsv8,"Opt Ker Guided Particle Filter STOXX")
plotproxy9<-Filtplot9(dfsv9,"Auxiliary Particle Filter STOXX")
plotproxy10<-Filtplot10(dfsv10,"Liu and West Filter STOXX")
plotproxy11<-Filtplot11(dfsv11,"Always Resampling STOXX")
plotproxy12<-Filtplot12(dfsv12,"No Resampling STOXX")
