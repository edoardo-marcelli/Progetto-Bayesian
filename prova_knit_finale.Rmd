...
```{r cll_plot, echo=FALSE, fig.align='center', fig.cap="Relative log-likelihood of S&P500 daily log returns, CV and SV", fig.height=3, fig.pos='H', fig.width=10, results=F}
