...
\begin{equation}
<<<<<<< HEAD
    \frac{1}{N}\sum_{n=1}^Nw(X^n) \varphi (X^n)\xrigtharrow{\text{a.s.}}  \E_\M(\varphi \cdot w)=\E_\Q(\varphi)\cdot \E_\M(w)
\end{equation}
Together with \eqref{is_conv_lln}, we get strong convergence of the estimator (that implies consistency).
\begin{equation}
   \hat \varphi_{AN}=\sum_{n=1}^NW^n \varphi (X^n)\xrigtharrow{\text{a.s.}}  \E_\Q(\varphi)
=======
...
>>>>>>> 2c40cdae00f6d2ea7ce1ad9c7e1468a02bf9063e
\end{equation}
